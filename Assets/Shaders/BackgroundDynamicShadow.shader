Shader "Brotherhood/NONPBR/BackgroundShadow" {
    Properties {
//        [Toggle]_UseNormalMap ("Use Normal Map", Float) = 1 // 0 or 1 for false or true
//        [Toggle]_UseShadowMap ("Use Shadow Map", Float) = 1 // 0 or 1 for false or true
